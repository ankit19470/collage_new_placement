...
function CompanyHome(){
  ...
  //   obj = obj +1
  //   if(obj<obj1){
  //      document.getElementById("change").innerHTML = obj
  //   }else{
  //      document.getElementById("change").innerHTML =obj1
  //   }
  // }
return(
    <>
    ...
    <div className="container-fluid">
      <div className="container py-3">
        ...
        <div className="row py-4">
          ...
          <div className="col-md-4 py-2">
            <div className="card" style={{ maxWidth: 500 }}>
              <img src="/assets/img/bn.jpg" className="card-img-top" alt="..." />
              <div className="card-body">
          ...
          <div className="col-md-4 py-2">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p>
                  <Link to="https://www.twitter.com" id="lp">
                    <i className="bi bi-twitter" />
                  </Link>
                  <Link to="https://www.facebook.com" id="lp">
                    
                    <i className="bi bi-facebook" />
                  </Link>
                  <Link to="https://www.instagram.com" id="lp">
